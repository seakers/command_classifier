...
def load_data_sources(daphne_version):
    ...
    if daphne_version == "AT":
        ...
        # Retrieve all component figures
...
def substitution_functions(daphne_version):
    ...
    if daphne_version == "EOSS":
        ...
        def subs_vassar_instrument(data_sources):
            options = ["ACE_ORCA", "ACE_POL", "ACE_LID", "CLAR_ERB", "ACE_CPR", "DESD_SAR", "DESD_LID", "GACM_VIS",
                       "GACM_SWIR",
    ...
    if daphne_version == "AT":
        ...
        def subs_component(data_sources):
            options = data_sources['component']
            return random.choice(options)
